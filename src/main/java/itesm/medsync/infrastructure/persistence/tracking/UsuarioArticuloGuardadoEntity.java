...
@Entity
@Table(name = "usuario_articulos_guardados")
@IdClass(UsuarioArticuloGuardadoId.class)
public class UsuarioArticuloGuardadoEntity {
    ...
    public LocalDateTime getGuardadoAt() {
        return guardadoAt;
    }

    public void setGuardadoAt(LocalDateTime guardadoAt) {
        this.guardadoAt = guardadoAt;
    }
}
